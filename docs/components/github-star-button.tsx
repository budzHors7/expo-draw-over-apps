...
export function GitHubStarButton() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="inline-flex items-center gap-2 rounded-full border border-zinc-900/10 bg-white px-4 py-2 text-sm font-medium text-zinc-950 transition hover:border-zinc-900/20 hover:bg-zinc-100 dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-50 dark:hover:bg-zinc-800"
    >
      <span className="rounded-full border border-zinc-900/10 bg-zinc-50 px-2.5 py-1 text-[11px] uppercase tracking-[0.18em] text-zinc-500 dark:border-white/10 dark:bg-white/6 dark:text-zinc-300">
